...
/**
 * Dictamen de designación del Jurado Informante (Etapa 7), posterior a que el estudiante solicita
 * el trámite. Comparte la numeración correlativa de la Unidad de Posgrado con los demás dictámenes.
 */
@Entity
@Table(name = "dictamenes_jurado_informe")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
...
public class DictamenJuradoInforme extends AuditableEntity {
