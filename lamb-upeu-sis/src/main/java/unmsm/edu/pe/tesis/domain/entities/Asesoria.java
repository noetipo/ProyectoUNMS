...
/**
 * Asesoría de un docente sobre una tesis. Pertenece al módulo de tesis (futuro);
 * aquí se define el mínimo necesario para CONTAR la carga del docente.
...
public class Asesoria extends AuditableEntity {
    ...
    @Column(length = 30)
    private String tipo; // ASESOR | COASESOR
}
