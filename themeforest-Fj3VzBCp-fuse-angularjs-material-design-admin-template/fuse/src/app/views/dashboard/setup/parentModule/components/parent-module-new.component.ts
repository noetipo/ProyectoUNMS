  ...
  template: `
    <div class="form-dialog w-[480px]" [class.anim-shake]="shaking()">
      ...
      <div class="form-dialog__header">
        <div>
          <h2 class="form-dialog__title">Nuevo módulo padre</h2>
          <p class="form-dialog__subtitle">Completa la información del módulo padre</p>
        </div>
...
export class ParentModuleNewComponent implements OnInit {
  ...
  dialogRef = inject(MatDialogRef<ParentModuleNewComponent>);
