...
@Component({
  selector: 'app-centro-laboral-new',
  standalone: true,
  imports: [
  ...
  template: `
    <div class="form-dialog w-[480px]" [class.anim-shake]="shaking()">
      <div class="form-dialog__header">
        <div>
          <h2 class="form-dialog__title">Nuevo centro laboral</h2>
          <p class="form-dialog__subtitle">Completa la información del centro laboral</p>
        </div>
        ...
        <div class="form-dialog__body">
          ...
          <div class="form-section" style="animation-delay:40ms">
            ...
            <mat-form-field appearance="outline" class="w-full" subscriptSizing="dynamic">
              <input matInput formControlName="nombre" placeholder="HOSPITAL NACIONAL DOS DE MAYO" />
            </mat-form-field>
          ...
          <div class="form-section" style="animation-delay:80ms">
            ...
            <mat-form-field appearance="outline" class="w-full" subscriptSizing="dynamic">
              <textarea matInput formControlName="descripcion" rows="3" placeholder="Descripción del centro laboral..."></textarea>
            </mat-form-field>
          </div>
...
export class CentroLaboralNewComponent implements OnInit {
  private _fb = inject(UntypedFormBuilder);
  dialogRef   = inject(MatDialogRef<CentroLaboralNewComponent>);
