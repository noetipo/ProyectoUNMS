    ...
    >
      ...
      <div class="flex items-center justify-between gap-x-3">
        <div class="flex flex-col gap-y-0.5">
          <div class="text-xl font-semibold tracking-tighter sm:text-2xl">
            Panel de Tesis y Titulación
          </div>
          <div class="text-neutral-500">
            Escuela de Posgrado · Facultad de Medicina — UNMSM
          </div>
        </div>
      ...
      >
        <mat-card-header>
          <div class="flex flex-auto items-center gap-x-2">
            <mat-icon
              ...
              svgIcon="chart-line"
            />
            <div class="font-medium tracking-tight">Resumen de tesis</div>
            <div class="ml-auto">
              <button
                class="tiny"
                matIconButton
              ...
              <mat-menu #salesChartMenu="matMenu">
                <button mat-menu-item>Descargar gráfico</button>
        ...
        <div class="grid grid-cols-4 gap-1">
          ...
          >
            <div class="flex items-center pt-6 pr-4 pl-6">
              <div class="flex flex-col">
                <div class="text-3xl font-semibold">Inscritas vs. Sustentadas</div>
                <div class="mt-0.5 text-sm text-neutral-500">
                  Se inscribieron más tesis de las que se sustentaron este
                  periodo. Conviene impulsar las sustentaciones pendientes.
                </div>
              </div>
            </div>
            <apx-chart
          ...
          >
            <div class="mt-1">
              Distribución de tesis según su estado actual.
            </div>
            ...
            <div class="mt-4 text-xs text-neutral-500">
              Incluye tesis de maestría, doctorado y especialidades de la
          ...
          <mat-card-header>
            <div class="flex flex-auto items-center gap-x-2">
              <mat-icon
                ...
                svgIcon="logs"
              />
              <div class="font-medium tracking-tight">Distribución por especialidad</div>
              <div class="ml-auto">
                <button
                  class="tiny"
                  matIconButton
        ...
        <mat-card appearance="filled">
          <mat-card-header>
            <div class="flex flex-auto items-center gap-x-2">
              ...
              />
              <div class="font-medium tracking-tight">Sustentaciones programadas</div>
              <div class="ml-auto">
                <button
                  class="tiny"
                  matIconButton
        ...
        <mat-card-header>
          <div class="flex flex-auto items-center gap-x-2">
            <mat-icon
              ...
              svgIcon="wallet"
            />
            <div class="font-medium tracking-tight">Tesis por programa</div>
            <div class="ml-auto">
              <button
                class="tiny"
                matIconButton
              ...
              <mat-menu #budgetMenu="matMenu">
                <button mat-menu-item>Exportar CSV</button>
                <button mat-menu-item>Exportar PDF</button>
                <button mat-menu-item>Exportar Excel</button>
                <mat-divider />
                <button mat-menu-item>Actualizar datos</button>
              </mat-menu>
            </div>
